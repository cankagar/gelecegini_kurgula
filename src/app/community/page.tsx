    ...
    <div className={styles.dashboard}>
      ...
      <div className={styles.grid}>
        <div className={styles.card} style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '4rem 2rem' }}>
          <h2 style={{ color: 'var(--color-primary)', marginBottom: '1rem', fontSize: '1.5rem' }}>Topluluk Çok Yakında!</h2>
          <p style={{ color: 'var(--color-text-muted)', marginBottom: '2rem' }}>
            Bilim projelerini paylaşabileceğin ve tartışabileceğin forum altyapısı şu an geliştirme aşamasında.
          </p>
