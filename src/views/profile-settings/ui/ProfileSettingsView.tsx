    ...
    <div className="w-full px-8 py-14 lg:px-12">
      <div className="mx-auto max-w-4xl">
        <motion.div initial="hidden" animate="show" variants={fadeUp} transition={{ duration: 0.7, ease: EASE }}>
          ...
          <p className="mt-2 font-serif text-[1.05rem] italic text-text-muted">
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 md:grid-cols-3">
          ...
          >
            <div className="rounded-[calc(2rem-0.5rem)] bg-bg p-7 shadow-[inset_0_1px_0_rgba(255,255,255,0.7)] sm:p-8">
              ...
              <div className="mt-7 flex items-center gap-2.5 border-t border-border pt-6">
                {isEditing ? (
                  <>
                    <button
                      onClick={save}
        ...
        {user.roles.includes("student") && <StudentDemographicsForm />}
      </div>
    </div>
  );
}
